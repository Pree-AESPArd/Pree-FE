//
//  SamllCircularProgressBar.swift
//  Pree
//
...
class SmallCircularProgressBar: UIView {
    ...
    private var lineWidth: CGFloat = 7  // 프로그래스 바의 두께
    ...
    private func setupLabel() {
        ...
        progressLabel?.font = UIFont(name: "Pretendard-Medium", size: 16)
    ...
    private func updateProgress() {
        ...
        // 색상 설정
        let progressColor = colorForScore(clampedValue)
